    ...
    <div className="px-12 pb-20">
      ...
      <div className="flex gap-12">
        <div>
          ...
          <div className="w-[315px] p-3.5 text-center hover:bg-amber-700 hover:text-white font-semibold absolute bottom-[15px] transform translate-y-30 transition-transform duration-300 ease-in-out group-hover:translate-y-0">
            + Add to Cart
          </div>
